...
ggsave("figure4-12.png",x, width = 8, height = 6, dpi = 720)
...
# Results from the solution into a tfd object after building the plot
...
x <-ggplot(df_tibble) +
  ...
  theme_minimal()
ggsave("figure4-1.png",x, width = 8, height = 6, dpi = 720)
...
x <-ggplot() +
  ...
  labs(#title = "US States Excess Mortality Curves with Cluster Colors",
       ...
       ,# or just "Latitude"
       y = "Latitude (°)" )
ggsave("figure4-4.png",x, width = 8, height = 6, dpi = 720)
...
ggsave("figure4-10.png",x, width = 8, height = 6, dpi = 720)
