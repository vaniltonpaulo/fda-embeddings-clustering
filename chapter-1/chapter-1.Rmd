...
```{r data, include=TRUE}
#weekly all-cause excess mortality between 2017 to end of 2020 
...
# ───Data Transformation ─────────────
#Its standard pratice  in tidyfun to create a tibble
nat_weekly <- tibble(
  # week-start dates
  date = date_state,
...
# ───Data ──────────────────
#Covid-19 associated deaths in the US
...
#So now we end up with a tfd object where each row (each curve represents a state)
